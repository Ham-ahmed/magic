...
GITHUB_RAW="https://raw.githubusercontent.com/Ham-ahmed/magic/refs/heads/main"

if [ ! -d /usr/lib64 ]; then
    PLUGINPATH=/usr/lib/enigma2/python/Plugins/Extensions/MagicPanel
else
    PLUGINPATH=/usr/lib64/enigma2/python/Plugins/Extensions/MagicPanel
fi
...
check_for_updates() {
    ...
    if [ "$version" != "$LATEST_VERSION" ]; then
        ...
        echo "#    https://github.com/Ham-ahmed/magic/main         #"
        echo "#########################################################"
        echo ""
...
wget https://raw.githubusercontent.com/Ham-ahmed/magic/refs/heads/main/MagicPanel_v6-main.tar.gz
if [ $? -ne 0 ]; then
